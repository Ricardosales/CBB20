    ...
    <View style={styles.card}>
        <View style={{ flex: 5, flexDirection: 'row' }}>
            <View style={{ backgroundColor: '#155239', width: 100, borderTopLeftRadius: 6, borderBottomLeftRadius: 6 }}>
                <Image
                    style={styles.imagem}
                    source={require('../../../assets/Lugares/pib.jpg')} />
            </View>
...
const Pib = () => {
    return (
        <ScrollView
            ...
            <CardHosp
                nome='Primeira Igreja Batista Goiânia'
                endereco='Rua 16 (esq. c/ a Rua 13) n° 286 - St. Central'
                telefone='(62) 3223-1717'
                latitude='-16.678348' longitude='-49.259831'
            />
